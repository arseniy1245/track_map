...
В лог попадают запуск сервера, API-запросы, загрузки маршрутов, изменения слоёв, удаление маршрутов, создание и переименование пользователей, а также системные ошибки Node.js: `uncaughtException`, `unhandledRejection`, `warning` и ошибки старта.
